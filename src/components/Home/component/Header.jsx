        ...
        <div className='flex flex-col mb-cover container px-4 md:px-15 lg:flex-row items-center w-full'>
          ...
          <div className="flex-1">
            <div className="relative ">
              ...
              <div className="absolute  bg-red-500  w-full h-full rounded-full blur-3xl"></div>

                <div className="relative flex items-center justify-center text-center">
                <img src={profil} alt="Image" class="rounded-lg mx-auto  object-cover h-[523px] aspect-video w-[523px] z-10" />
              </div>
            </div>
          </div>
